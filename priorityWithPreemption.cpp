...
<<<<<<< HEAD
	public:
		int process, burstTime, arrivalTime, priority, waitTime, turnaroundTime;
=======
public:
...
>>>>>>> ae16323e873e4d82570e0aadf811db70916989da
};
...
void outputTable(int n, int runNumber, int avgWaitTime, int avgTurnaroundTime){
